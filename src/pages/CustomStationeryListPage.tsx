...
const CustomStationeryListPage: React.FC = () => {
  ...
  const fetchStationery = async () => {
    try {
      setLoading(true);
      const response = await productService.getBusinessProducts({ category: 'stationery', limit: 12 });
      setStationery(response.data.products || []);
    } catch (err) {
    ...
    <div style={{ backgroundColor: '#f0f0f0', minHeight: '100vh' }}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Custom Stationery</h1>
          <p className="text-gray-600">Bespoke stationery items tailored to your brand</p>
        </div>

        {/* Products Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-8">
          {stationery.map((product, index) => (
            <div
            ...
            >
              ...
              <div
                ...
                style={{ height: '200px', backgroundColor: product.bg || '#d4c9b8' }}
              >
                <div className="flex items-center justify-center w-full h-full px-8">
                  <div className="bg-white rounded-xl shadow-md w-full max-w-[180px] p-4 flex flex-col gap-2">
                    ...
                    <div className="h-8 bg-gray-50 rounded-lg mt-2" />
...
export default CustomStationeryListPage;